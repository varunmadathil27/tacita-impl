    ...
    for<'a, 'b> &'a P: Sub<&'b P, Output = P>,
{
    ...
    /// let params = KZG10::<Bls12_381, UniPoly_381>::setup(10, rng).expect("Setup failed");
    /// ```
    ...
    /// let comm = KZG10::<Bls12_381, UniPoly_381>::commit_g1(&params, &secret_poly).expect("Commitment failed");
    /// assert!(!comm.is_zero(), "Commitment should not be zero");
    /// ```
    pub fn commit_g1(
